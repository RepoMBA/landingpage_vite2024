...
export default function SalesforceHeroSection() {
  return (
    <div className="mt-[50px]">
      <div>
        {" "}
        <div className="min-h-[90vh] justify-between w-full flex items-center">
          <div className="w-full md:w-2/3 pl-[4%] lg:w-1/2 bg-white bg-opacity-80 1200sm:bg-transparent p-6 rounded-lg">
            ...
            <div className="mt-4 text-[#5d5d5d] text-[18px] sm:text-[20px] md:text-[18px] leading-[30px]">
              ...
              you use every day to accelerate contract flow and move your
              business forward.
            </div>
