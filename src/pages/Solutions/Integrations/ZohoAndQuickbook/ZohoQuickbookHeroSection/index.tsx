...
export default function ZohoQuickbookHeroSection() {
  return (
    <div>
      {" "}
      <section className="bg-white ">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <a
            href="#"
            className="inline-flex justify-between items-center py-1 px-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full "
            role="alert"
          >
          ...
          <h1 className="mb-4 text-4xl font-semibold tracking-tight leading-none text-gray-900">
            Zoho and Quickbooks Integration
          </h1>
          <p className="mb-8 text-[16px] font-normal text-gray-500sm:px-16 xl:px-48">
            Legitt AI Contract Intelligence Integration with Zoho and Quickbooks
          </p>
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 "
            >
              Learn more
              <svg
            ...
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border "
            >
              <svg
                  ...
                  <g transform="matrix(1.3333 0 0 -1.3333 0 100.08)">
                    <g transform="matrix(.29378 0 0 .29378 0 .042373)">
                      <g transform="translate(740.38 200.84)">
                        <path
                          d="m0 0v-175.61l-24.248-23.659v171.73l24.248 27.54"
                          fill="#e79224"
                        />
                      </g>
                      <path
                        d="m716.52 173.3h-160.57v-171.94h160.57z"
                        fill="url(#linearGradient30)"
                      />
                      <g transform="translate(581.1 200.72)">
                        <path
                          d="m0 0-25.151-27.424h160.57l23.857 27.54-159.28-0.116"
                          fill="#fef26f"
                        />
                      </g>
                      ...
                      <g transform="translate(540.18 215.15)">
                        <path
                          d="m0 0 0.122-0.93 20.484-157.73-11.94-33.25-21.881 154.04"
                          fill="#0b9ad6"
                        />
                      </g>
                      <g clip-path="url(#clipPath70)">
                        <path
                          d="m0 255.36h740.38v-255.3h-740.38z"
