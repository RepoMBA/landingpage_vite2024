        ...
        <div className="px-[6%] mt-[50px]"> 
            <div className="text-[#4e4d4c] flex gap-[2px] justify-between items-center">
                <div className="text-[black] w-1/2">
                    <h2 className="text-[28px]"><b>About Us</b></h2>
                    <h1 className="text-[46px]"><b>Transforming the way world handles contracts</b></h1>
                    <p>At Legitt AI, we revolutionize the way businesses manage their contracts through cuttingedge Assistive Intelligence technology. As the world's first Assistive Intelligence platform dedicated to Contract Lifecycle Management (CLM), we cater to the diverse needs of organizations, offering tailored solutions to both startups and enterprise clients.</p>
                </div>
                <div className="w-1/2 flex justify-end">
                    <img src="https://d2qb2qddg7l6c6.cloudfront.net/assets/images/aboutusHero.svg"  className="w-full" alt='AboutUsHero'/>
                </div>
            </div>
            ...
            <div className="text-[#4e4d4c] flex gap-[2px] justify-center mt-[50px] mb-[50px]">
                <div className="w-1/2 flex items-center">
                    ...
                    <h1 className="text-[48px] text-black"><b>Our Mission</b></h1>
                </div>
                <div className="text-[black] w-1/2">
            ...
            <div className="text-[#4e4d4c] flex gap-[2px] justify-center mt-[50px] mb-[50px]">
                ...
                <div className="w-1/2 justify-end flex">
                    <h1 className="mt-[50px] text-[48px] text-black"><b>Vision</b></h1>
            ...
            <div className="text-[#4e4d4c] flex gap-[2px] justify-between items-center  mt-[50px] mb-[50px]">
                <div className="w-1/2 flex">
                    ...
                    <h1 className="text-[48px] text-black"><b>Technology</b></h1>
                </div>
                <div className="text-[black] w-1/2">
