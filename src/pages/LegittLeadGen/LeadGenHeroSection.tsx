...
export default function LeadGenHeroSection() {
  return (
    <div>
      <section className="relative mt-[100px] sm:mt-[150px]">
        <div className="mx-auto px-5 md:px-10 max-w-7xl">
          <div className="mb-10 max-w-3xl mx-auto text-center">
            <h1 className="mb-4 text-3xl md:text-5xl font-semibold">
              ...
              <span className="relative mx-3 mt-3 whitespace-nowrap text-[#000]">
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
                  className="absolute top-[30px] left-1/2 -translate-x-1/2 h-4 md:h-6 fill-current text-pink-400"
                ...
                <span className="relative">appreciate it.</span>
              </span>
            </h1>
