      ...
      <section className="bg-[#29165E]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-4">
            <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-[#fff] dark:border-gray-700">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  ...
                  />
                  <span className="font-medium text-black">Jese Leos</span>
                </div>
                <a
                  href="#"
            ...
            <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-[#fff] dark:border-gray-700">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  ...
                  />
                  <span className="font-medium text-black">Bonnie Green</span>
                </div>
                <a
                  href="#"
                  className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline"
